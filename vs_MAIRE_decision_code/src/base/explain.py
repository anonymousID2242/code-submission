...
class explain(obj_functions):
  ...
  def __init__(self, explain_point, sampled_points_num, f_value_explain_point, lambda_val_1, lambda_val, threshold, plot_function = None):
    ...
    #self.explain_point = [0.0,0.565 , 0.435 , 0.15 ,  0.99 ,  0.5795, 0.1825, 0.206  ]
    #self.explain_point = np.asarray(self.explain_point)
    #self.explain_point = tf.convert_to_tensor(self.explain_point)
    print(self.explain_point)
    #exit()
  ...
  def fit_explanation(self, num_of_iterations, verbose = 1):
    ...
    for iteration in range(num_of_iterations):
      ...
      if verbose != 0 and iteration % verbose == 0:
        ...
        coverage_values.append(row_values[2])
        exp_coverage_values.append(row_values[4])
        precision_values.append(row_values[3])
        exp_precision_values.append(row_values[5])
        #print("done")
    ...
    #print(self.l_vec_values)
    #print("\n")
    #print(self.u_vec_values)
